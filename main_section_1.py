from section_1_models import BasicNet,BasicNetSkipCon
...
def train(input_config, output_config, model_config):
    ...
    if name == "BasicCNN":
        ...
        raise(ValueError("Available models {}".format(["BasicCNN", "CNNskipcon"])))
    ...
    trainer = pl.Trainer(max_epochs = mc["max_epochs"], callbacks = [early_stopping, callback],gpus=-1,flush_logs_every_n_steps = 20, log_every_n_steps= 20,
